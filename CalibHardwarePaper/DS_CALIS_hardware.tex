...
%---
\begin{abstract}
This report describes design, fabrication, commisioning and use of  a calibration source insertion system (CALIS) in \dsf\ experiment. CALIS  deploys radioactive sources into liquid scintillator veto to characterize detector response and detection efficiency of \dsf\ Liquid Argon Time Projection Chamber used for dark matter detection, and surrounding \lsvscintillatormass\ organic liquid scintillator neutron veto.
