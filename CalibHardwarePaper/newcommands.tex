...
\newcommand{\AmBe}{\ensuremath{^{241}}Am\ensuremath{^9}Be}
\newcommand{\AmC}{\ensuremath{^{241}}Am\ensuremath{^{13}}C}
...
\newcommand{\timefno}{\SI{90}{\nano\second}} %from def.tex of AAr paper
\newcommand{\fixedintone}{\SI{7}{\micro\second}} %from def.tex of AAr paper
...
%
\newcommand{\tdrift}{\ensuremath{t_{drift}}}