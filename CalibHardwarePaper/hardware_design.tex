...
\begin{figure}[htbp]
 \centering
 %\subfigure{ \includegraphics[width=0.7\textwidth]{Figs/gearDrawing}}
 \includegraphics[width=0.72\textwidth]{Figs/CALISDimensions.png}
 \includegraphics[width=0.27\textwidth]{Figs/CALIS_overview_IMG_3763.jpg}
...
\centering
  \includegraphics[width=\textwidth]{Figs_BriYann/SourcePod2_mirrored.jpg}
\end{minipage}
\begin{minipage}[b]{0.48\textwidth}
\centering
  \includegraphics[width=\textwidth]{Figs/sourceArmArticulation.png}
  \includegraphics[width=0.8\textwidth]{Figs/IMG_2457.JPG}
\end{minipage}
