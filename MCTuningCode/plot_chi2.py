...
class MCTuning_Plot(MCT.MCTuning):
    ...
    def Plot(self):
        ...
        t.ReadFile("%s/%s/chi2_%s.txt" % (self._output_dir, self._par1_name, self._par1_name),"par1:chi2_colleff:chi2_topbottom:ndf_colleff:ndf_topbottom");
        ...
        c.SaveAs("%s/%s/chi2_%s.C" % (self._output_dir, self._par1_name, self._par1_name))
        c.SaveAs("%s/%s/chi2_%s.png" % (self._output_dir, self._par1_name, self._par1_name))
